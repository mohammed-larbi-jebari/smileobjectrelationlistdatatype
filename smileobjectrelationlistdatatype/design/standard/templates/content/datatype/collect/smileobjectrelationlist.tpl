...
{else}    {* Standard mode is browsing *}
    <div class="block" id="smileobjectrelationlist_browse_{$attribute.id}">
    ...
    {* Optional controls. *}
    {include uri='design:content/datatype/edit/smileobjectrelationlist_controls.tpl'}
    ...
    {/if}
    </div><!-- /div class="block" id="smileobjectrelationlist_browse_{$attribute.id}" -->
{/if}
{/let}