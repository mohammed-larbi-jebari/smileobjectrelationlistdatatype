 ...
 *
 */
class smileObjectRelationListType extends eZDataType
{
    const DATA_TYPE_STRING = "smileobjectrelationlist";
    /*!
     Initializes with a string id and a description.
    */
    function smileObjectRelationListType()
    {
        $this->eZDataType( self::DATA_TYPE_STRING, ezpI18n::tr( 'kernel/classes/datatypes', "smile Object relations" ),
    ...
    */
    function validateObjectAttributeHTTPInput( $http, $base, $contentObjectAttribute )
    {
        ...
        $postVariableName = $base . "_data_smile_object_relation_list_" . $contentObjectAttribute->attribute( "id" );
        $contentClassAttribute = $contentObjectAttribute->contentClassAttribute();
    ...
    */
    ...
    function fetchClassAttributeHTTPInput( $http, $base, $classAttribute )
    {
        ...
        $postVariable = 'ContentClass_smileobjectrelationlist_class_list_' . $classAttribute->attribute( 'id' );
        ...
        $typeVariable = 'ContentClass_smileobjectrelationlist_type_' . $classAttribute->attribute( 'id' );
        if ( $http->hasPostVariable( $typeVariable ) )
        {
            $type = $http->postVariable( $typeVariable );
            $content['type'] = $type;
        }
        $selectionTypeVariable = 'ContentClass_smileobjectrelationlist_selection_type_' . $classAttribute->attribute( 'id' );
    ...
    function customObjectAttributeHTTPAction( $http, $action, $contentObjectAttribute, $parameters )
    {
        ...
        else if ( $action == 'browse_objects' )
        {
            ...
            $browseParameters = array( 'action_name' => 'AddRelatedObject_' . $contentObjectAttribute->attribute( 'id' ),
                    'type' =>  $browseType,
                    'browse_custom_action' => array( 'name' => 'CustomActionButton[' . $contentObjectAttribute->attribute( 'id' ) . '_set_smile_object_relation_list]',
        ...
        else if ( $action == 'set_smile_object_relation_list' )
        {
    ...
    */
    static function removeRelationObject( $contentObjectAttribute, $deletionItem )
    {
        ...
        if ( $isDeletionAllowed )
        {
            ...
            //Mobel AND !$deletionItem['in_trash']
    ...
    */
    ...
    function fetchCollectionAttributeHTTPInput( $collection, $collectionAttribute, $http, $base, $contentObjectAttribute )
    {
        ...
        // Check if selection type is not browse
        if ( $classContent['selection_type'] != 0 AND $selectedObjectIDArray !== false)
        {
            $priority = 0;
            $content['relation_list'] = array();
            foreach ( $selectedObjectIDArray as $objectID )
            ...
            $this->storeObjectAttributeContent( $collectionAttribute, $content );
...
eZDataType::register( smileObjectRelationListType::DATA_TYPE_STRING, "smileObjectRelationListType" );
?>